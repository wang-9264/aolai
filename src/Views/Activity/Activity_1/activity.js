        ...
        return (
            this.state.datalist.length?
                ...
                {this.state.datalist[0].cons.map(item=>
                  ...
                  <img src={"https://img4.aolaigo.com/group1/"+(item.src).replace(/.*group1/,'')} style={{width:"1.25rem",margin:"0",padding:'0',float:"left"}} key={item.src} onClick={()=>(item.typeName =="search")?(this.listClick(item.skuid)):null}/>
                  )}
                  ...
                  <li onClick={()=>this.detailClick(item.skuid)} style={{width:"1.15rem"}} key={item.skuid}>
                  ...
                  <li onClick={()=>this.detailClick(item.skuid)} style={{width:"1.15rem"}} key={item.src}>
                    <img src={item.src?"https://img4.aolaigo.com/group1/" + (item.src).replace(/http.*group1/,''):"data:image/png;base64,"}/>
